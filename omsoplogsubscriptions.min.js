...
function OmsOplogSubscriptions(o){var i=this;i.opLogCollection=o,i.docCollection=o.docCollection,i._oneSubscriptions={},i._collectionSubscriptions={},i._collectionQueries={},i._opLogQueries={},i.opLogCollection.on("insert",function(o){i._publish(o)})}var OmsSubscriptions=require("./OmsSubscriptions"),OmsUtils=require("./OmsUtils"),OmsSubscriptionController=require("./OmsSubscriptionController");OmsOplogSubscriptions.prototype.subscribeOneResume=function(o,i,t,e){},OmsOplogSubscriptions.prototype.findSubscribeOne=function(o,i,t){function e(t){var e=r._objectMerge(o,{_id:t});r.findSubscribe(e,i,function(o,i){o?s(o):"subscribe"==i.operation.operation?"subscribed"==i.operation.status?l.collectionSubscription=i.operation.options.subscriptionId:"find-complete"!=i.operation.status||c||(c=!0,s(null,i)):(s(null,i),"remove"==i.operation.operation&&r.unsubscribe(u,function(){n()}))})}function n(){r.findSubscribe(o,i,function(o,i){if(o)s(o);else if("subscribe"==i.operation.operation)"subscribed"==i.operation.status?l.collectionSubscription=i.operation.options.subscriptionId:"find-complete"!=i.operation.status||c||(c=!0,s(null,i));else if("insert"==i.operation.operation){var t=i.operation.doc._id;r.unsubscribe(l.collectionSubscription,function(){e(t)})}})}function s(o,i){t(o,i)}var r=this,c=!1,u=r._uniqueId();r._oneSubscriptions[u]={};var l=r._oneSubscriptions[u],p=OmsSubscriptionController({cancel:function(o){r.unsubscribe(u,o)}}),b=OmsUtils.operationObject("subscribe",["subscribed",{subscriptionId:u}]);return s(null,OmsUtils.operationDoc(b)),"string"==typeof o._id?e(o._id):n(),p},OmsOplogSubscriptions.prototype.subscribeResume=function(o,i,t,e){var n=this;return n.opLogCollection.findOne({_id:o},function(s,r){function c(){null==u?n.subscribe(i,t,e):n.opLogCollection.findOne({_id:u.data},function(o,s){if(o)e(o,null);else{var r=n.opLogSubscriptionComputedDoc(s,t,i);null!=r&&e(null,r),u=u.next,c()}})}if(s&&e(s,null),null==r)e("last_op_not_found",null);else{var u=n.opLogCollection.docsLinkedList.list[o];u=u.next,c()}})},OmsOplogSubscriptions.prototype.opLogSubscriptionComputedDoc=function(o,i,t){return OmsUtils.docMatch(o,i)?this.operationSubscriptionComputedDoc(o,t):null},OmsOplogSubscriptions.prototype.operationSubscriptionComputedDoc=function(o,i){switch(o.operation.operation){case"insert":case"remove":if(OmsUtils.docMatch(o.operation.doc,i))return this._objectMerge(o,{src:"subscription"});break;case"update":var t=OmsUtils.docMatch(o.operation.unmodifiedDoc,i),e=OmsUtils.docMatch(o.operation.modifiedDoc,i);if(t&&e)return o;if(t&&!e)var n=OmsUtils.operationObject("remove",[o.operation.unmodifiedDoc]);else{if(t||!e)return null;var n=OmsUtils.operationObject("insert",[o.operation.modifiedDoc])}var s=OmsUtils.operationDoc(n);return this._objectMerge(s,{_srcOpId:o._id,src:"subscription_translated"});default:throw new Error("unknown_event")}return null},OmsOplogSubscriptions.prototype.findSubscribe=function(o,i,t){function e(){t.apply(n,Array.prototype.slice.call(arguments))}var n=this,s=(n._uniqueId(),!1),r=OmsSubscriptionController({cancel:function(o){s?o("not_found",null):(s=!0,o(null,!0))}});return n.docCollection.find(o,function(s,c){if(s)t(s,null);else{var u=n.subscribe(o,i,e);r.handlers=u.handlers,c.forEach(function(o){var i=OmsUtils.operationObject("insert",[o]),e=n._objectMerge(OmsUtils.operationDoc(i),{src:"subscription_setup"});t(null,e)});var l=OmsUtils.operationObject("subscribe",["find-complete"]);t(null,OmsUtils.operationDoc(l))}}),r},OmsOplogSubscriptions.prototype.subscribe=function(o,i,t){var e=this,n=e._queryKey(e._collectionQueries,o);e._collectionQueries[n].usages++;var s=e._queryKey(this._opLogQueries,i);e._opLogQueries[s].usages++;var r=e._uniqueId();this._collectionSubscriptions[r]={collectionQueryKey:n,opLogQueryKey:s,callback:t};var c=OmsUtils.operationObject("subscribe",["subscribed",{subscriptionId:r}]);return t(null,OmsUtils.operationDoc(c)),OmsSubscriptionController({cancel:function(o){e.unsubscribe(r,o)}})},OmsOplogSubscriptions.prototype.subscriptionExists=function(o){return"object"==typeof this._oneSubscriptions[o]||"object"==typeof this._collectionSubscriptions[o]},OmsOplogSubscriptions.prototype.unsubscribe=function(o,i){function t(o,t){"function"==typeof i&&i(o,t)}if("object"==typeof this._oneSubscriptions[o]){var e=this._oneSubscriptions[o];"string"==typeof e.collectionSubscription?this.unsubscribe(e.collectionSubscription,function(i,e){i?t(i,null):(delete this._oneSubscriptions[o],t(null,!0))}):(delete this._oneSubscriptions[o],t(null,!0))}else if("object"==typeof this._collectionSubscriptions[o]){var e=this._collectionSubscriptions[o],n=e.collectionQueryKey,s=this._collectionQueries[n];s.usages--,s.usages<=0&&delete this._collectionQueries[n];var r=e.opLogQueryKey,c=this._opLogQueries[r];c.usages--,c.usages<=0&&delete this._opLogQueries[r],t(null,!0)}else t("subscription_not_found",null)},OmsOplogSubscriptions.prototype._publish=function(o){var i=this,t={},e={};this._objectForEach(i._collectionSubscriptions,function(n,s){var r=n.collectionQueryKey;if("object"==typeof i._collectionQueries[r]){var c=i._collectionQueries[r].query,u=n.opLogQueryKey,l=i._opLogQueries[u].query;"boolean"!=typeof e[u]&&(e[u]=OmsUtils.docMatch(o,l)),e[u]&&("boolean"!=typeof t[r]&&(t[r]=i.operationSubscriptionComputedDoc(o,c)),null!=t[r]&&n.callback(null,t[r]))}})},OmsOplogSubscriptions.prototype._queryKey=function(o,i){var t;for(t in o)if(o.hasOwnProperty(t)&&this._objectDeepEqual(o[t].query,i))return t;var e=this._uniqueId();return o[e]={usages:0,query:i},e},OmsOplogSubscriptions.prototype._uniqueId=function(){function o(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}return o()+o()+"-"+o()+"-"+o()+"-"+o()+"-"+o()+o()+o()},OmsOplogSubscriptions.prototype._objectDeepEqual=function(o,i){if("object"==typeof o&&null!=o&&"object"==typeof i&&null!=i){if(Object.keys(o).length!=Object.keys(i).length)return!1;for(var t in o){if(!i.hasOwnProperty(t))return!1;if(!this._objectDeepEqual(o[t],i[t]))return!1}return!0}return o===i},OmsOplogSubscriptions.prototype._objectForEach=function(o,i){var t;for(t in o)o.hasOwnProperty(t)&&i(o[t],t,o)},OmsOplogSubscriptions.prototype._objectMerge=function(){var o={};return this._objectForEach(arguments,function(i){for(var t in i)i.hasOwnProperty(t)&&(o[t]=i[t])}),o},module.exports=function(o){return new OmsOplogSubscriptions(o)};
},{"./OmsSubscriptionController":28,"./OmsSubscriptions":29,"./OmsUtils":30}],28:[function(require,module,exports){
function OmsSubscriptionController(n){this.handlers="object"==typeof n&&null!=n?n:{}}OmsSubscriptionController.prototype.cancel=function(n){function o(o,t){"function"==typeof n&&n(o,t)}var t=this;"function"==typeof t.handlers.cancel?t.handlers.cancel(o):o("not_defined",null)},module.exports=function(n){return new OmsSubscriptionController(n)};
...
},{"./OmsUtils":30}],30:[function(require,module,exports){
