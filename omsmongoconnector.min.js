...
var FauxMongo=require("fauxmongo"),OmsUtils={};OmsUtils.docMatch=function(o,e){return FauxMongo.matchQuery(o,e)},OmsUtils.operationFunctionArguments=function(o){switch(o.operation){case"insert":return[o.doc,o.options];case"update":return[{_id:o.unmodifiedDoc._id},o.updateOperation,o.options];case"remove":return[{_id:o.doc._id},o.options];default:throw new Error("undefined_operation_type")}},OmsUtils.operationDoc=function(o){return{date:new Date,operation:o}},OmsUtils.operationObjectMin=function(o,e){if(Array.isArray(e))var t=OmsUtils.operationObject(o,e);else var t=e;switch(o){case"insert":return t;case"remove":return{operation:t.operation,doc:{_id:t.doc._id},options:t.options};case"update":return{operation:t.operation,unmodifiedDoc:{_id:t.unmodifiedDoc._id},updateOperation:t.updateOperation,options:t.options}}},OmsUtils.operationObject=function(o,e){switch(o){case"insert":case"remove":return{operation:o,doc:e[0],options:"object"!=typeof e[1]&&null==e[1]?{}:e[1]};case"update":return{operation:o,unmodifiedDoc:e[0],modifiedDoc:e[1],updateOperation:e[2],options:"object"!=typeof e[3]&&null==e[3]?{}:e[3]};default:throw new Error("undefined_operation_type")}},module.exports=OmsUtils;
