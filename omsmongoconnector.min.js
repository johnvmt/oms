...
},{"wolfy87-eventemitter":28}],25:[function(require,module,exports){
...
},{"./support/isBuffer":26,"_process":23,"inherits":25}],28:[function(require,module,exports){
...
},{"./FunctionUtils":29,"queue-emitter":24}],31:[function(require,module,exports){
...
},{"./FunctionUtils":29,"./OmsIntercept":30,"./OmsSubscriptions":32,"./Utils":34,"fauxmongo":4,"wolfy87-eventemitter":28}],32:[function(require,module,exports){
function OmsSubscriptions(t){this.opLogSubscriptions=t}var OmsUtils=require("./OmsUtils");OmsSubscriptions.prototype.findSubscribeObject=function(){var t="function"==typeof arguments[1]?arguments[0]:{},i="function"==typeof arguments[0]?arguments[0]:arguments[1];return this.opLogSubscriptions.findSubscribe(t,{},function(t,n){t?i(t):i(t,n.type,n.operation)})},OmsSubscriptions.prototype.subscribeObject=function(){var t="function"==typeof arguments[1]?arguments[0]:{},i="function"==typeof arguments[0]?arguments[0]:arguments[1];return this.opLogSubscriptions.subscribe(t,{},function(t,n){t?i(t):i(t,n.type,n.operation)})},OmsSubscriptions.prototype.findSubscribe=function(){var t="function"==typeof arguments[0]?{}:arguments[0],i="function"==typeof arguments[0]?arguments[0]:arguments[1];return this.findSubscribeObject(t,function(t,n,o){t?i(t):i.apply(this,[t,n].concat(OmsUtils.operationFunctionArguments(n,o)))})},OmsSubscriptions.prototype.subscribe=function(){var t="function"==typeof arguments[0]?{}:arguments[0],i="function"==typeof arguments[0]?arguments[0]:arguments[1];return this.subscribeObject(t,function(t,n,o){t?i(t):i.apply(this,[t,n].concat(OmsUtils.operationFunctionArguments(n,o)))})},OmsSubscriptions.prototype.unsubscribe=function(t){return this.opLogSubscriptions.unsubscribe(t)},module.exports=function(t){return new OmsSubscriptions(t)};
},{"./OmsUtils":33}],33:[function(require,module,exports){
var FauxMongo=require("fauxmongo"),OmsUtils={};OmsUtils.docMatch=function(e,o){return FauxMongo.matchQuery(e,o)},OmsUtils.operationFunctionArguments=function(e,o){switch(e){case"insert":return[o.doc,o.options];case"update":return[{_id:o.unmodifiedDoc._id},o.updateOperation,o.options];case"remove":return[{_id:o.doc._id},o.options];default:throw new Error("undefined_operation_type")}},OmsUtils.operationDoc=function(e,o){return{type:e,date:new Date,operation:o}},OmsUtils.operationObjectMin=function(e,o){if(Array.isArray(o))var t=OmsUtils.operationObject(e,o);else var t=o;switch(e){case"insert":return t;case"remove":return{doc:{_id:t.doc._id},options:t.options};case"update":return{unmodifiedDoc:{_id:t.unmodifiedDoc._id},updateOperation:t.updateOperation,options:t.options}}},OmsUtils.operationObject=function(e,o){switch(e){case"insert":case"remove":return{doc:o[0],options:"object"!=typeof o[1]&&null==o[1]?{}:o[1]};case"update":return{unmodifiedDoc:o[0],modifiedDoc:o[1],updateOperation:o[2],options:"object"!=typeof o[3]&&null==o[3]?{}:o[3]};default:throw new Error("undefined_operation_type")}},module.exports=OmsUtils;
},{"fauxmongo":4}],34:[function(require,module,exports){
...
//# sourceMappingURL=omsmongoconnector.js.map