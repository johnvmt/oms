...
},{"queue-emitter":24}],30:[function(require,module,exports){
function OmsMongoConnector(e){var t=this;this.operationsQueue=[],this.mongoIntercept=OmsIntercept(e),t._replicateCollectionFunctions();var n=null;t.mongoIntercept.on("pre-insert",function(){var e=Utils.parseArgs(arguments,[{name:"opId",level:0,validate:function(e,t){return"undefined"!=typeof e}},{name:"docs",level:0,validate:function(e,t){return"object"==typeof e}},{name:"options",level:1,validate:function(e,t){return"object"==typeof e},default:{}},{name:"next",level:0,validate:function(e,t){return"function"==typeof e}}]);t.queue(function(o){n=o,t._docs=e.docs,e.next()})}),t.mongoIntercept.on("insert",function(e,o,r){var i=arguments[arguments.length-1];Array.isArray(t._docs)||(t._docs=[t._docs]),t._docs.forEach(function(e){t.emit("insert",e)}),delete t.docs,n(),i()}),t.mongoIntercept.on("pre-update",function(){var e=Utils.parseArgs(arguments,[{name:"opId",level:0,validate:function(e,t){return"undefined"!=typeof e}},{name:"query",level:1,validate:function(e,t){return"object"==typeof e||"string"==typeof e},default:{}},{name:"updateOperations",level:0,validate:function(e,t){return"object"==typeof e}},{name:"options",level:1,validate:function(e,t){return"object"==typeof e},default:{}},{name:"next",level:1,validate:function(e,t){return"function"==typeof e}}]);"string"==typeof e.query&&(e.query={_id:e.query}),t.queue(function(o){function r(n,o){n?e.next(n):(t._unmodifiedDocs={},o.forEach(function(e){t._unmodifiedDocs[e._id]=t._cloneObject(e)}),t._updateOperations=e.updateOperations,e.next())}n=o,"object"==typeof e.options&&e.options.multi?t.mongoIntercept.find(e.query,r):t.mongoIntercept.findOne(e.query,function(e,t){var n=[t];r(e,n)})})}),t.mongoIntercept.on("update",function(){var e=arguments[arguments.length-1],o=t._validateUpdate(t._updateOperations);Utils.objectForEach(t._unmodifiedDocs,function(e){var n=t._updateDoc(e,o,!0);t.emit("update",e,n,t._updateOperations)}),delete t._unmodifiedDocs,delete t._updateOperations,n(),e()}),t.mongoIntercept.on("pre-remove",function(){var e=Utils.parseArgs(arguments,[{name:"opId",level:0,validate:function(e,t){return"undefined"!=typeof e}},{name:"query",level:1,validate:function(e,t){return"object"==typeof e||"string"==typeof e},default:{}},{name:"options",level:1,validate:function(e,t){return"object"==typeof e},default:{}},{name:"next",level:1,validate:function(e,t){return"function"==typeof e}}]);"string"==typeof e.query&&(e.query={_id:e.query}),t.queue(function(o){n=o,t.mongoIntercept.find(e.query,function(n,o){n?e.next(n):(t._unmodifiedDocs={},o.forEach(function(e){t._unmodifiedDocs[e._id]=t._cloneObject(e)}),e.next())})})}),t.mongoIntercept.on("remove",function(){var e=arguments[arguments.length-1];Utils.objectForEach(t._unmodifiedDocs,function(e){t.emit("remove",e)}),delete t._unmodifiedDocs,n(),e()})}var EventEmitter=require("wolfy87-eventemitter"),FauxMongo=require("fauxmongo"),OmsIntercept=require("./OmsIntercept"),OmsSubscriptions=require("./OmsSubscriptions"),Utils=require("./Utils");OmsMongoConnector.prototype.__proto__=EventEmitter.prototype,OmsMongoConnector.prototype.queue=function(e){var t=this,n=function(){t.operationsQueue.shift(),t.operationsQueue.length&&t.operationsQueue[0]()};t.operationsQueue.push(e),1==t.operationsQueue.length&&e(n)},OmsMongoConnector.prototype._replicateCollectionFunctions=function(){var e=this,t=this.mongoIntercept,n=this._objectPublicFunctions(t),o=[];n.forEach(function(n){"undefined"==typeof e[n]&&o.indexOf(n)<0&&(e[n]=function(){t[n].apply(t,Array.prototype.slice.call(arguments))})})},OmsMongoConnector.prototype._objectPublicFunctions=function(e){function t(e){var t=[];for(var n in e)"function"==typeof e[n]&&t.push(n);return t}return t(e).filter(function(e){return"_"!==e[0]&&"globalFunctions"!==e})},OmsMongoConnector.prototype._validateUpdate=function(e){var t={};return Utils.objectForEach(e,function(e,n){"$set"==n?t.$set=Utils.objectMerge(t.$set,n):"$"==n.charAt(0)?t[n]=e:("object"==typeof t.$set&&null!=t.$set||(t.$set={}),t.$set[n]=e)}),t},OmsMongoConnector.prototype._updateDoc=function(e,t,n){"boolean"==typeof n&&n&&(e=this._cloneObject(e));var o={};return Utils.objectForEach(t,function(t,n){"$"==n.charAt(0)?o[n]=t:e[n]=t}),FauxMongo.update(e,o),e},OmsMongoConnector.prototype._cloneObject=function(e){return JSON.parse(JSON.stringify(e))},module.exports=function(e){return new OmsMongoConnector(e)};
},{"./OmsIntercept":29,"./OmsSubscriptions":31,"./Utils":32,"fauxmongo":4,"wolfy87-eventemitter":28}],31:[function(require,module,exports){
function OmsSubscriptions(t){var i=this;i.subscriptions={},i.collection=t,i.maxSubscriptionId=0,i._replicateFunctions(i.collection);var o=["insert","update","remove"];o.forEach(function(t){i.collection.on(t,function(){i._publish.apply(i,[t].concat(Array.prototype.slice.call(arguments)))})})}var FauxMongo=require("fauxmongo");OmsSubscriptions.prototype.findSubscribe=function(){function t(){c&&o.apply(n,Array.prototype.slice.call(arguments))}var i="function"==typeof arguments[0]?{}:arguments[0],o="function"==typeof arguments[0]?arguments[0]:arguments[1],n=this,c=!1,r=n.subscribe(i,t);return n.collection.find(i,function(t,i){t?o(t,null):(c=!0,i.forEach(function(t){o(null,"insert",t)}))}),r},OmsSubscriptions.prototype.subscribe=function(){var t="function"==typeof arguments[1]?arguments[0]:{},i="function"==typeof arguments[0]?arguments[0]:arguments[1];return this.maxSubscriptionId++,this.subscriptions[this.maxSubscriptionId]={query:t,callback:i},this.maxSubscriptionId},OmsSubscriptions.prototype.unsubscribe=function(t){delete this.subscriptions[t]},OmsSubscriptions.prototype._publish=function(){var t=Array.prototype.slice.call(arguments),i=t.shift(),o=this,n=o.collection;switch(i){case"insert":var c=t[0];o._objectForEach(this.subscriptions,function(t,r){n._docFilter(c,t.query)&&o._subscriptionCallback(t,i,c)});break;case"remove":var c=t[0];o._objectForEach(this.subscriptions,function(t,r){n._docFilter(c,t.query)&&o._subscriptionCallback(t,i,c)});break;case"update":var r=t[0],s=t[1],u=t[2];o._objectForEach(this.subscriptions,function(t,i){var c=n._docFilter(r,t.query),e=n._docFilter(s,t.query);c&&e?o._subscriptionCallback(t,"update",r,s,u):c&&!e?o._subscriptionCallback(t,"remove",r):!c&&e&&o._subscriptionCallback(t,"insert",s)})}},OmsSubscriptions.prototype._docFilter=function(t,i){return FauxMongo.matchQuery(t,i)},OmsSubscriptions.prototype._subscriptionCallback=function(){var t=Array.prototype.slice.call(arguments),i=t.shift();try{i.callback.apply(i,[null].concat(t))}catch(t){}},OmsSubscriptions.prototype._objectForEach=function(t,i){var o;for(o in t)t.hasOwnProperty(o)&&i(t[o],o,t)},OmsSubscriptions.prototype._replicateFunctions=function(t){var i=this,o=this._objectPublicFunctions(t),n=[];o.forEach(function(o){"undefined"==typeof i[o]&&n.indexOf(o)<0&&(i[o]=function(){t[o].apply(t,Array.prototype.slice.call(arguments))})})},OmsSubscriptions.prototype._objectPublicFunctions=function(t){function i(t){var i=[];for(var o in t)"function"==typeof t[o]&&i.push(o);return i}return i(t).filter(function(t){return"_"!==t[0]&&"globalFunctions"!==t})},module.exports=function(t){return new OmsSubscriptions(t)};
},{"fauxmongo":4}],32:[function(require,module,exports){
