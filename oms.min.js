...
},{"./IndexedLinkedList":23,"./MongoLocalCursor":25,"./Utils":26,"fauxmongo":4,"objectid":27,"wolfy87-eventemitter":33}],25:[function(require,module,exports){
...
},{"wolfy87-eventemitter":33}],30:[function(require,module,exports){
...
},{"./support/isBuffer":31,"_process":28,"inherits":30}],33:[function(require,module,exports){
...
var FunctionUtils={};FunctionUtils.objectPublicFunctions=function(n){function t(n){var t=[];for(var i in n)"function"==typeof n[i]&&t.push(i);return t}return t(n).filter(function(n){return"_"!==n[0]&&"globalFunctions"!==n})},FunctionUtils.objectReplicateFunctions=function(n,t,i){Array.isArray(i)||(i=[]);var o=FunctionUtils.objectPublicFunctions(n);o.forEach(function(o){"undefined"==typeof t[o]&&i.indexOf(o)<0&&(t[o]=function(){n[o].apply(n,Array.prototype.slice.call(arguments))})})},module.exports=FunctionUtils;
},{}],35:[function(require,module,exports){
function OmsIntercept(t){this.collection=t,this._maxOpId=0,this._replicateInterceptCollectionFunctions()}var QueueEmitter=require("queue-emitter"),FunctionUtils=require("./FunctionUtils");OmsIntercept.prototype.__proto__=QueueEmitter.prototype,OmsIntercept.prototype._replicateInterceptCollectionFunctions=function(){var t=this,n=FunctionUtils.objectPublicFunctions(this.collection),o=["isCapped"];n.forEach(function(n){"undefined"==typeof t[n]&&o.indexOf(n)<0&&(t[n]=function(){t._collectionFunction(n,Array.prototype.slice.call(arguments))})})},OmsIntercept.prototype._collectionFunction=function(t,n){function o(o){null!==o?e(o):r.collection[t].apply(r.collection,n.concat([e]))}function e(){u=Array.prototype.slice.call(arguments),r.emit.apply(r,[t].concat(p).concat(u).concat([c]))}function c(t){if("function"==typeof l){var n=Array.prototype.slice.call(arguments);n.shift(),i(n)}}function i(){"function"==typeof l&&l.apply(r,u)}var r=this,p=r._maxOpId,u=void 0;if(r._maxOpId++,Array.isArray(n)&&n.length>0&&"function"==typeof n[n.length-1])var l=n.pop();r.emit.apply(r,["pre-"+t].concat(p).concat(n).concat([o]))},OmsIntercept.prototype._objectPublicFunctions=function(t){function n(t){var n=[];for(var o in t)"function"==typeof t[o]&&n.push(o);return n}return n(t).filter(function(t){return"_"!==t[0]&&"globalFunctions"!==t})},module.exports=function(t){return new OmsIntercept(t)};
},{"./FunctionUtils":34,"queue-emitter":29}],36:[function(require,module,exports){
...
},{"./FunctionUtils":34}],37:[function(require,module,exports){
function OmsMongoConnector(e){var t=this;this.operationsQueue=[],this.mongoIntercept=OmsIntercept(e),FunctionUtils.objectReplicateFunctions(t.mongoIntercept,t);var n=null;t.mongoIntercept.on("pre-insert",function(){var e=Utils.parseArgs(arguments,[{name:"opId",level:0,validate:function(e,t){return"undefined"!=typeof e}},{name:"docs",level:0,validate:function(e,t){return"object"==typeof e}},{name:"options",level:1,validate:function(e,t){return"object"==typeof e},default:{}},{name:"next",level:0,validate:function(e,t){return"function"==typeof e}}]);t.queue(function(o){n=o,t._docs=e.docs,e.next()})}),t.mongoIntercept.on("insert",function(e,o,r){var i=arguments[arguments.length-1];Array.isArray(t._docs)||(t._docs=[t._docs]),t._docs.forEach(function(e){t.emit("insert",e)}),delete t.docs,n(),i()}),t.mongoIntercept.on("pre-update",function(){var e=Utils.parseArgs(arguments,[{name:"opId",level:0,validate:function(e,t){return"undefined"!=typeof e}},{name:"query",level:1,validate:function(e,t){return"object"==typeof e||"string"==typeof e},default:{}},{name:"updateOperations",level:0,validate:function(e,t){return"object"==typeof e}},{name:"options",level:1,validate:function(e,t){return"object"==typeof e},default:{}},{name:"next",level:1,validate:function(e,t){return"function"==typeof e}}]);"string"==typeof e.query&&(e.query={_id:e.query}),t.queue(function(o){function r(n,o){n?e.next(n):(t._unmodifiedDocs={},o.forEach(function(e){t._unmodifiedDocs[e._id]=t._cloneObject(e)}),t._updateOperations=e.updateOperations,e.next())}n=o,"object"==typeof e.options&&e.options.multi?t.mongoIntercept.find(e.query,r):t.mongoIntercept.findOne(e.query,function(e,t){var n=[t];r(e,n)})})}),t.mongoIntercept.on("update",function(){var e=arguments[arguments.length-1],o=t._validateUpdate(t._updateOperations);Utils.objectForEach(t._unmodifiedDocs,function(e){var n=t._updateDoc(e,o,!0);t.emit("update",e,n,t._updateOperations)}),delete t._unmodifiedDocs,delete t._updateOperations,n(),e()}),t.mongoIntercept.on("pre-remove",function(){var e=Utils.parseArgs(arguments,[{name:"opId",level:0,validate:function(e,t){return"undefined"!=typeof e}},{name:"query",level:1,validate:function(e,t){return"object"==typeof e||"string"==typeof e},default:{}},{name:"options",level:1,validate:function(e,t){return"object"==typeof e},default:{}},{name:"next",level:1,validate:function(e,t){return"function"==typeof e}}]);"string"==typeof e.query&&(e.query={_id:e.query}),t.queue(function(o){n=o,t.mongoIntercept.find(e.query,function(n,o){n?e.next(n):(t._unmodifiedDocs={},o.forEach(function(e){t._unmodifiedDocs[e._id]=t._cloneObject(e)}),e.next())})})}),t.mongoIntercept.on("remove",function(){var e=arguments[arguments.length-1];Utils.objectForEach(t._unmodifiedDocs,function(e){t.emit("remove",e)}),delete t._unmodifiedDocs,n(),e()})}var EventEmitter=require("wolfy87-eventemitter"),FauxMongo=require("fauxmongo"),OmsIntercept=require("./OmsIntercept"),OmsSubscriptions=require("./OmsSubscriptions"),Utils=require("./Utils"),FunctionUtils=require("./FunctionUtils");OmsMongoConnector.prototype.__proto__=EventEmitter.prototype,OmsMongoConnector.prototype.queue=function(e){var t=this,n=function(){t.operationsQueue.shift(),t.operationsQueue.length&&t.operationsQueue[0]()};t.operationsQueue.push(e),1==t.operationsQueue.length&&e(n)},OmsMongoConnector.prototype._validateUpdate=function(e){var t={};return Utils.objectForEach(e,function(e,n){"$set"==n?t.$set=Utils.objectMerge(t.$set,n):"$"==n.charAt(0)?t[n]=e:("object"==typeof t.$set&&null!=t.$set||(t.$set={}),t.$set[n]=e)}),t},OmsMongoConnector.prototype._updateDoc=function(e,t,n){"boolean"==typeof n&&n&&(e=this._cloneObject(e));var o={};return Utils.objectForEach(t,function(t,n){"$"==n.charAt(0)?o[n]=t:e[n]=t}),FauxMongo.update(e,o),e},OmsMongoConnector.prototype._cloneObject=function(e){return JSON.parse(JSON.stringify(e))},module.exports=function(e){return new OmsMongoConnector(e)};
},{"./FunctionUtils":34,"./OmsIntercept":35,"./OmsSubscriptions":40,"./Utils":43,"fauxmongo":4,"wolfy87-eventemitter":33}],38:[function(require,module,exports){
function OmsOplog(o,e,n){var i=this;i.docCollection=o,i.opLogCollection=MongoLocal(e),i.docsLinkedList=i.opLogCollection.docsLinkedList,FunctionUtils.objectReplicateFunctions(i.opLogCollection,i);var t=["insert","update","remove"];t.forEach(function(e){o.on(e,function(){var o=OmsUtils.operationObject(e,arguments),t=OmsUtils.operationDoc(o);if("object"==typeof o.options&&"undefined"!=typeof o.options._operation){var p=o.options._operation;delete o.options._operation,"undefined"==typeof p._id&&"undefined"!=typeof p._srcId&&(t._id=p._srcOpId),t.src="applied"}else t=Utils.objectMerge(n,t,{src:"local"});i.opLogCollection.insert(t)})})}var MongoLocal=require("mongolocal"),FunctionUtils=require("./FunctionUtils"),OmsUtils=require("./OmsUtils"),Utils=require("./Utils");OmsOplog.prototype.applyOp=function(o){function e(o){Utils.objectSet(o.operation,["options","_operation"],o);var e=OmsUtils.operationFunctionArguments(o.operation);"function"==typeof n.docCollection[o.operation.operation]&&n.docCollection[o.operation.operation].apply(n.docCollection,e)}var n=this;if("undefined"==typeof o)throw new Error("operation_undefined");var i="undefined"!=typeof o._id?o._id:o._srcOpId;"undefined"!=typeof i?n.opLogCollection.findOne({_id:i},function(n,i){n||null!=i||e(o)}):e(o)},module.exports=function(o,e,n){return new OmsOplog(o,e,n)};
},{"./FunctionUtils":34,"./OmsUtils":41,"./Utils":43,"mongolocal":24}],39:[function(require,module,exports){
function OmsOplogSubscriptions(o){var t=this;t.opLogCollection=o,t.docCollection=o.docCollection,t._subscriptions={},t._collectionQueries={},t._opLogQueries={},this.opLogCollection.on("insert",function(o){t._publish(o)})}var OmsSubscriptions=require("./OmsSubscriptions"),OmsUtils=require("./OmsUtils");OmsOplogSubscriptions.prototype.subscribeResume=function(o,t,e,i){var s=this;s.opLogCollection.findOne({_id:o},function(r,n){function u(){null==c?s.subscribe(t,e,i):s.opLogCollection.findOne({_id:c.data},function(o,r){if(o)i(o,null);else{var n=s.opLogSubscriptionComputedDoc(r,e,t);null!=n&&i(null,n),c=c.next,u()}})}if(r&&i(r,null),null==n)i("last_op_not_found",null);else{var c=s.opLogCollection.docsLinkedList.list[o];c=c.next,u()}})},OmsOplogSubscriptions.prototype.opLogSubscriptionComputedDoc=function(o,t,e){return OmsUtils.docMatch(o,t)?this.operationSubscriptionComputedDoc(o,e):null},OmsOplogSubscriptions.prototype.operationSubscriptionComputedDoc=function(o,t){switch(o.operation.operation){case"insert":case"remove":if(OmsUtils.docMatch(o.operation.doc,t))return this._objectMerge(o,{src:"subscription"});break;case"update":var e=OmsUtils.docMatch(o.operation.unmodifiedDoc,t),i=OmsUtils.docMatch(o.operation.modifiedDoc,t);if(e&&i)return o;if(e&&!i)var s=OmsUtils.operationObject("remove",[o.operation.unmodifiedDoc]);else{if(e||!i)return null;var s=OmsUtils.operationObject("insert",[o.operation.modifiedDoc])}var r=OmsUtils.operationDoc(s);return this._objectMerge(r,{_srcOpId:o._id,src:"subscription_translated"});default:throw new Error("unknown_event")}return null},OmsOplogSubscriptions.prototype.findSubscribe=function(o,t,e){function i(){e.apply(s,Array.prototype.slice.call(arguments))}var s=this;s.docCollection.find(o,function(r,n){if(r)e(r,null);else{s.subscribe(o,t,i),n.forEach(function(o){var t=OmsUtils.operationObject("insert",[o]),i=s._objectMerge(OmsUtils.operationDoc(t),{src:"subscription_setup"});e(null,i)});var u=OmsUtils.operationObject("subscribe",["find-complete"]);e(null,OmsUtils.operationDoc(u))}})},OmsOplogSubscriptions.prototype.subscribe=function(o,t,e){var i=this._queryKey(this._collectionQueries,o);this._collectionQueries[i].usages++;var s=this._queryKey(this._opLogQueries,t);this._opLogQueries[s].usages++;var r=this._uniqueId();this._subscriptions[r]={collectionQueryKey:i,opLogQueryKey:s,callback:e};var n=OmsUtils.operationObject("subscribe",["subscribed",{subscriptionId:r}]);return e(null,OmsUtils.operationDoc(n)),r},OmsOplogSubscriptions.prototype._publish=function(o){var t=this,e={},i={};this._objectForEach(t._subscriptions,function(s,r){var n=s.collectionQueryKey,u=t._collectionQueries[n].query,c=s.opLogQueryKey,p=t._opLogQueries[c].query;"boolean"!=typeof i[c]&&(i[c]=OmsUtils.docMatch(o,p)),i[c]&&("boolean"!=typeof e[n]&&(e[n]=t.operationSubscriptionComputedDoc(o,u)),null!=e[n]&&s.callback(null,e[n]))})},OmsOplogSubscriptions.prototype._queryKey=function(o,t){var e;for(e in o)if(o.hasOwnProperty(e)&&this._objectDeepEqual(o[e].query,t))return e;var i=this._uniqueId();return o[i]={usages:0,query:t},i},OmsOplogSubscriptions.prototype.unsubscribe=function(o){var t=this._subscriptions[o];if(!t)throw new Error("subscription_not_found");var e=t.collectionQueryKey,i=this._collectionQueries[e];i.usages--,i.usages<=0&&delete this._collectionQueries[e];var s=t.opLogQueryKey,r=this._opLogQueries[s];r.usages--,r.usages<=0&&delete this._opLogQueries[s]},OmsOplogSubscriptions.prototype._uniqueId=function(){function o(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}return o()+o()+"-"+o()+"-"+o()+"-"+o()+"-"+o()+o()+o()},OmsOplogSubscriptions.prototype._objectDeepEqual=function(o,t){if("object"==typeof o&&null!=o&&"object"==typeof t&&null!=t){if(Object.keys(o).length!=Object.keys(t).length)return!1;for(var e in o){if(!t.hasOwnProperty(e))return!1;if(!this._objectDeepEqual(o[e],t[e]))return!1}return!0}return o===t},OmsOplogSubscriptions.prototype._objectForEach=function(o,t){var e;for(e in o)o.hasOwnProperty(e)&&t(o[e],e,o)},OmsOplogSubscriptions.prototype._objectMerge=function(){var o={};return this._objectForEach(arguments,function(t){for(var e in t)t.hasOwnProperty(e)&&(o[e]=t[e])}),o},module.exports=function(o){return new OmsOplogSubscriptions(o)};
},{"./OmsSubscriptions":40,"./OmsUtils":41}],40:[function(require,module,exports){
...
},{"./OmsIntercept":35,"./OmsLayers":36,"./OmsMongoConnector":37,"./OmsOplog":38,"./OmsOplogSubscriptions":39,"./OmsSubscriptions":40,"./OmsUtils":41}],43:[function(require,module,exports){
var Utils={};Utils.objectFilterProperties=function(e,t){var n={};return t.forEach(function(t){n[t]=e[t]}),n},Utils.objectDeepEqual=function(e,t){if("object"==typeof e&&null!=e&&"object"==typeof t&&null!=t){if(Object.keys(e).length!=Object.keys(t).length)return!1;for(var n in e){if(!t.hasOwnProperty(n))return!1;if(!Utils.objectDeepEqual(e[n],t[n]))return!1}return!0}return e===t},Utils.objectContainsObject=function(e,t){for(var n in t)if(t.hasOwnProperty(n)&&(!e.hasOwnProperty(n)||e[n]!=t[n]))return!1;return!0},Utils.objectFilter=function(e,t){var n={};return this.objectForEach(e,function(e,r,o){t(e,r,o)&&(n[r]=e)}),n},Utils.objectForEach=function(e,t){var n;for(n in e)e.hasOwnProperty(n)&&t(e[n],n,e)},Utils.objectGet=function(e,t){var n=this;if(0==t.length)return e;if("object"==typeof e){if(("string"==typeof t[0]||"number"==typeof t[0])&&null!==e&&e.hasOwnProperty(t[0]))return this.objectGet(e[t[0]],t.slice(1));if(null===t[0]){if(Array.isArray(e)){var r=[];e.forEach(function(e,o){r[o]=n.objectGet(e,t.slice(1))})}else{var r={};this.objectForEach(e,function(e,o){r[o]=n.objectGet(e,t.slice(1))})}return r}if(t[0]instanceof RegExp){var r={};return this.objectForEach(e,function(e,o){o.match(t[0])&&(r[o]=n.objectGet(e,t.slice(1)))}),r}if("function"==typeof t[0]){if(e instanceof Array){var r=[];e.forEach(function(e,o,i){t[0](e,o,i)&&(r[o]=n.objectGet(e,t.slice(1)))})}else{var r={};this.objectForEach(n.objectFilter(e,t[0]),function(e,o){r[o]=n.objectGet(e,t.slice(1))})}return r}if(t[0]instanceof Array){if(e instanceof Array){var r=[];t[0].forEach(function(t,n){r[n]=e[n]})}else{var r={};this.objectForEach(n.objectFilterProperties(e,t[0]),function(e,o){r[o]=n.objectGet(e,t.slice(1))})}return r}}},Utils.objectSet=function(e,t,n){return 1==t.length?(e[t[0]]=n,!0):("undefined"==typeof e[t[0]]&&(e[t[0]]={}),this.objectSet(e[t[0]],t.slice(1),n))},Utils.objectIsset=function(e,t){return 1==t.length?"undefined"!=typeof e[t[0]]:"undefined"!=typeof e[t[0]]&&this.objectIsset(e[t[0]],t.slice(1))},Utils.objectMerge=function(){var e={};return this.objectForEach(arguments,function(t){for(var n in t)t.hasOwnProperty(n)&&(e[n]=t[n])}),e},Utils.uniqueId=function(){function e(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}return e()+e()+"-"+e()+"-"+e()+"-"+e()+"-"+e()+e()+e()},Utils.parseArgs=function(e,t){function n(e,t){return"function"!=typeof e.validate||e.validate(t)}function r(e,t){for(var n=t;n<e.length;n++)if("undefined"==typeof e[n]||!e[n].required)return!0;return!1}var o={},i=0;return Array.isArray(e)||(e=Array.prototype.slice.call(e)),e.forEach(function(e,u){for(var c=i;c<t.length;c++){if(t[c].required){if(n(t[c],e)){t[c].matched=!0,o[t[c].name]=e,i++;break}throw"missing_required"}if(!t[c].required&&(r(t,c)||t[c].level>t[c-1].level&&t[c-1].matched)&&n(t[c],e)){t[c].matched=!0,o[t[c].name]=e,i++;break}t[c].matched=!1,i++}}),t.forEach(function(e){"undefined"==typeof o[e.name]&&"undefined"!=typeof e.default&&(o[e.name]=e.default)}),o},Utils.callbackQueue=function(){function e(){r||(r=!0,n.queueCompleteCallback.apply(this,Array.prototype.slice.call(arguments)))}function t(){o++,"function"==typeof n.queueFunctions[o]?Array.isArray(n.queueFunctionArgs)&&!n.options.expand?n.queueFunctions[o](n.queueFunctionArgs,t,e):Array.isArray(n.queueFunctionArgs)&&n.options.expand?n.queueFunctions[o].apply(this,n.queueFunctionArgs.concat([t,e])):n.queueFunctions[o](t,e):"function"!=typeof n.queueNoMatchCallback||r||n.queueNoMatchCallback()}var n=Utils.parseArgs(arguments,[{name:"queueFunctions",level:0,validate:function(e,t){return Array.isArray(e)}},{name:"queueFunctionArgs",level:1,validate:function(e,t){return Array.isArray(e)}},{name:"queueCompleteCallback",level:0,validate:function(e,t){return"function"==typeof e}},{name:"queueNoMatchCallback",level:1,validate:function(e,t){return"function"==typeof e}},{name:"options",level:1,validate:function(e,t){return"object"==typeof e},default:{}}]);n.options=Utils.objectMerge({expand:!1},n.options);var r=!1,o=-1;t()},module.exports=Utils;
},{}]},{},[42])(42)
});
