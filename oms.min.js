...
function Oms(t){this.collection=t,this._maxOpId=0,this._replicateCollectionFunctions()}var QueueEmitter=require("../../queue-emitter");Oms.prototype.__proto__=QueueEmitter.prototype,Oms.prototype._replicateCollectionFunctions=function(){var t=this,o=t._objectPublicFunctions(this.collection),n=["isCapped"];o.forEach(function(o){"undefined"==typeof t[o]&&n.indexOf(o)<0&&(t[o]=function(){t._collectionFunction(o,Array.prototype.slice.call(arguments))})})},Oms.prototype._collectionFunction=function(t,o){function n(n){null!==n?c(n):r.collection[t].apply(r.collection,o.concat([c]))}function c(){l=Array.prototype.slice.call(arguments),r.emit.apply(r,[t].concat(p).concat(l).concat([i]))}function i(t){if("function"==typeof u){var o=Array.prototype.slice.call(arguments);o.shift(),e(o)}}function e(){"function"==typeof u&&u.apply(r,l)}var r=this,p=r._maxOpId,l=void 0;if(r._maxOpId++,Array.isArray(o)&&o.length>0&&"function"==typeof o[o.length-1])var u=o.pop();r.emit.apply(r,["pre-"+t].concat(p).concat(o).concat([n]))},Oms.prototype._objectPublicFunctions=function(t){function o(t){var o=[];for(var n in t)"function"==typeof t[n]&&o.push(n);return o}return o(t).filter(function(t){return"_"!==t[0]&&"globalFunctions"!==t})},module.exports=function(t){return new Oms(t)};
},{"../../queue-emitter":3}],2:[function(require,module,exports){
