...
var FauxMongo=require("fauxmongo"),OmsUtils={};OmsUtils.docMatch=function(o,e){return FauxMongo.matchQuery(o,e)},OmsUtils.operationFunctionArguments=function(o,e){switch(o){case"insert":return[e.doc,e.options];case"update":return[{_id:e.unmodifiedDoc._id},e.updateOperation,e.options];case"remove":return[{_id:e.doc._id},e.options];default:throw new Error("undefined_operation_type")}},OmsUtils.operationDoc=function(o,e){return{type:o,date:new Date,operation:e}},OmsUtils.operationObject=function(o,e){switch(o){case"insert":return{doc:e[0],options:"object"!=typeof e[1]&&null==e[1]?{}:e[1]};case"update":return{unmodifiedDoc:e[0],modifiedDoc:e[1],updateOperation:e[2],options:"object"!=typeof e[3]&&null==e[3]?{}:e[3]};case"remove":return{doc:e[0],options:"object"!=typeof e[1]&&null==e[1]?{}:e[1]};default:throw new Error("undefined_operation_type")}},module.exports=OmsUtils;
