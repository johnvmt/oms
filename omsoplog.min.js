...
function OmsOplog(o,n,e){var t=this;t.docCollection=o,t.opLogCollection=MongoLocal(n),t.docsLinkedList=t.opLogCollection.docsLinkedList,FunctionUtils.objectReplicateFunctions(t.opLogCollection,t);var i=["insert","update","remove"];i.forEach(function(n){o.on(n,function(){var o=OmsUtils.operationObject(n,arguments);if("object"==typeof o.options&&"undefined"!=typeof o.options._operation){var i=o.options._operation;i._id="undefined"!=typeof i._id?i._id:i._srcOpId}else{var i=OmsUtils.operationDoc(n,o);i=Utils.objectMerge(e,i)}t.opLogCollection.insert(i)})})}var MongoLocal=require("mongolocal"),FunctionUtils=require("./FunctionUtils"),OmsUtils=require("./OmsUtils"),Utils=require("./Utils");OmsOplog.prototype.applyOp=function(o){function n(o){Utils.objectSet(o.operation,["options","_operation"],o);var n=OmsUtils.operationFunctionArguments(o.type,o.operation);"function"==typeof e.docCollection[o.type]&&e.docCollection[o.type].apply(e.docCollection,n)}var e=this;if("undefined"==typeof o)throw new Error("operation_undefined");var t="undefined"!=typeof o._id?o._id:o._srcOpId;if("undefined"==typeof t)throw new Error("operation_id_undefined");e.opLogCollection.findOne({_id:t},function(e,t){e||null!=t||n(o)})},OmsOplog.prototype.opsAfterForEach=function(o,n){var e=this.opLogCollection,t=e._docsLinkedList,i=t[o];if("undefined"==typeof i)n("op_not_found",null);else for(;null!=i;)e.findOne({_id:i.data},n),i=i.next},module.exports=function(o,n,e){return new OmsOplog(o,n,e)};
