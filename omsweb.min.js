...
function OmsOplog(o,i,n){var t=this;t.docCollection=o,t.opLogCollection=MongoLocal(i),t.docsLinkedList=t.opLogCollection.docsLinkedList,FunctionUtils.objectReplicateFunctions(t.opLogCollection,t);var e=["insert","update","remove"];e.forEach(function(i){o.on(i,function(){var o=OmsUtils.operationObject(i,arguments);if("object"==typeof o.options&&"undefined"!=typeof o.options._operation){var e=o.options._operation;e._id="undefined"!=typeof e._id?e._id:e._srcOpId,"undefined"==typeof e._id?e.src="subscription_find":e.src="subscription_translate",t.opLogCollection.insert(e)}else{var e=OmsUtils.operationDoc(o);e=Utils.objectMerge(n,e),e.src="local",t.opLogCollection.insert(e)}})})}var MongoLocal=require("mongolocal"),FunctionUtils=require("./FunctionUtils"),OmsUtils=require("./OmsUtils"),Utils=require("./Utils");OmsOplog.prototype.applyOp=function(o){function i(o){Utils.objectSet(o.operation,["options","_operation"],o);var i=OmsUtils.operationFunctionArguments(o.operation);"function"==typeof n.docCollection[o.operation.operation]&&n.docCollection[o.operation.operation].apply(n.docCollection,i)}var n=this;if("undefined"==typeof o)throw new Error("operation_undefined");var t="undefined"!=typeof o._id?o._id:o._srcOpId;"undefined"!=typeof t?n.opLogCollection.findOne({_id:t},function(n,t){n||null!=t||i(o)}):i(o)},module.exports=function(o,i,n){return new OmsOplog(o,i,n)};
