(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.omsweb = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
},{"./IndexedLinkedList":23,"./MongoLocalCursor":25,"./Utils":26,"fauxmongo":4,"objectid":27,"wolfy87-eventemitter":32}],25:[function(require,module,exports){
...
function OmsOplog(o,n,i){var e=this;e.docCollection=o,e.opLogCollection=MongoLocal(n),e.docsLinkedList=e.opLogCollection.docsLinkedList,FunctionUtils.objectReplicateFunctions(e.opLogCollection,e);var t=["insert","update","remove"];t.forEach(function(n){o.on(n,function(){var o=OmsUtils.operationObject(n,arguments);if("object"==typeof o.options&&"undefined"!=typeof o.options._operation){var t=o.options._operation;t._id="undefined"!=typeof t._id?t._id:t._srcOpId}else{var t=OmsUtils.operationDoc(o);t=Utils.objectMerge(i,t)}e.opLogCollection.insert(t)})})}var MongoLocal=require("mongolocal"),FunctionUtils=require("./FunctionUtils"),OmsUtils=require("./OmsUtils"),Utils=require("./Utils");OmsOplog.prototype.applyOp=function(o){function n(o){console.log("O-DOC",o),Utils.objectSet(o.operation,["options","_operation"],o);var n=OmsUtils.operationFunctionArguments(o.operation);"function"==typeof i.docCollection[o.operation.operation]&&i.docCollection[o.operation.operation].apply(i.docCollection,n)}var i=this;if("undefined"==typeof o)throw new Error("operation_undefined");var e="undefined"!=typeof o._id?o._id:o._srcOpId;if("undefined"==typeof e)throw new Error("operation_id_undefined");i.opLogCollection.findOne({_id:e},function(i,e){i||null!=e||n(o)})},module.exports=function(o,n,i){return new OmsOplog(o,n,i)};
},{"./FunctionUtils":33,"./OmsUtils":37,"./Utils":39,"mongolocal":24}],35:[function(require,module,exports){
function OmsOplogSubscriptions(o){var t=this;t.opLogCollection=o,t.docCollection=o.docCollection,t._subscriptions={},t._collectionQueries={},t._opLogQueries={},this.opLogCollection.on("insert",function(o){t._publish(o)})}var OmsSubscriptions=require("./OmsSubscriptions"),OmsUtils=require("./OmsUtils");OmsOplogSubscriptions.prototype.subscribeResume=function(o,t,e,i){var r=this;r.opLogCollection.findOne({_id:o},function(n,s){function u(){null==c?r.subscribe(t,e,i):r.opLogCollection.findOne({_id:c.data},function(o,n){if(o)i(o,null);else{var s=r.opLogSubscriptionComputedDoc(n,e,t);null!=s&&i(null,s),c=c.next,u()}})}if(n&&i(n,null),null==s)i("last_op_not_found",null);else{var c=r.opLogCollection.docsLinkedList.list[o];c=c.next,u()}})},OmsOplogSubscriptions.prototype.opLogSubscriptionComputedDoc=function(o,t,e){return OmsUtils.docMatch(o,t)?this.operationSubscriptionComputedDoc(o,e):null},OmsOplogSubscriptions.prototype.operationSubscriptionComputedDoc=function(o,t){switch(o.operation.operation){case"insert":case"remove":if(OmsUtils.docMatch(o.operation.doc,t))return o;break;case"update":var e=OmsUtils.docMatch(o.operation.unmodifiedDoc,t),i=OmsUtils.docMatch(o.operation.modifiedDoc,t);if(e&&i)return o;if(e&&!i){var r=OmsUtils.operationObject("remove",[o.operation.unmodifiedDoc]),n=OmsUtils.operationDoc(r);return n._srcOpId=o._id,n}if(!e&&i){var r=OmsUtils.operationObject("insert",[o.operation.modifiedDoc]),n=OmsUtils.operationDoc(r);return n._srcOpId=o._id,n}break;default:throw new Error("unknown_event")}return null},OmsOplogSubscriptions.prototype.findSubscribe=function(o,t,e){function i(){n&&e.apply(r,Array.prototype.slice.call(arguments))}var r=this,n=!1,s=r.subscribe(o,t,i);return r.docCollection.find(o,function(o,t){o?e(o,null):(n=!0,t.forEach(function(o){var t=OmsUtils.operationObject("insert",[o]),i=OmsUtils.operationDoc(t);e(null,i)}))}),s},OmsOplogSubscriptions.prototype.subscribe=function(o,t,e){var i=this._queryKey(this._collectionQueries,o);this._collectionQueries[i].usages++;var r=this._queryKey(this._opLogQueries,t);this._opLogQueries[r].usages++;var n=this._uniqueId();return this._subscriptions[n]={collectionQueryKey:i,opLogQueryKey:r,callback:e},n},OmsOplogSubscriptions.prototype._publish=function(o){var t=this,e={},i={};this._objectForEach(t._subscriptions,function(r,n){var s=r.collectionQueryKey,u=t._collectionQueries[s].query,c=r.opLogQueryKey,p=t._opLogQueries[c].query;"boolean"!=typeof i[c]&&(i[c]=OmsUtils.docMatch(o,p)),i[c]&&("boolean"!=typeof e[s]&&(e[s]=t.operationSubscriptionComputedDoc(o,u)),null!=e[s]&&r.callback(null,e[s]))})},OmsOplogSubscriptions.prototype._queryKey=function(o,t){var e;for(e in o)if(o.hasOwnProperty(e)&&this._objectDeepEqual(o[e].query,t))return e;var i=this._uniqueId();return o[i]={usages:0,query:t},i},OmsOplogSubscriptions.prototype.unsubscribe=function(o){var t=this._subscriptions[o];if(!t)throw new Error("subscription_not_found");var e=t.collectionQueryKey,i=this._collectionQueries[e];i.usages--,i.usages<=0&&delete this._collectionQueries[e];var r=t.opLogQueryKey,n=this._opLogQueries[r];n.usages--,n.usages<=0&&delete this._opLogQueries[r]},OmsOplogSubscriptions.prototype._uniqueId=function(){function o(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}return o()+o()+"-"+o()+"-"+o()+"-"+o()+"-"+o()+o()+o()},OmsOplogSubscriptions.prototype._objectDeepEqual=function(o,t){if("object"==typeof o&&null!=o&&"object"==typeof t&&null!=t){if(Object.keys(o).length!=Object.keys(t).length)return!1;for(var e in o){if(!t.hasOwnProperty(e))return!1;if(!this._objectDeepEqual(o[e],t[e]))return!1}return!0}return o===t},OmsOplogSubscriptions.prototype._objectForEach=function(o,t){var e;for(e in o)o.hasOwnProperty(e)&&t(o[e],e,o)},module.exports=function(o){return new OmsOplogSubscriptions(o)};
},{"./OmsSubscriptions":36,"./OmsUtils":37}],36:[function(require,module,exports){
...
},{"./OmsUtils":37}],37:[function(require,module,exports){
...
},{"fauxmongo":4}],38:[function(require,module,exports){
module.exports={OmsOplog:require("./OmsOplog"),OmsOplogSubscriptions:require("./OmsOplogSubscriptions"),OmsSubscriptions:require("./OmsSubscriptions"),OmsUtils:require("./OmsUtils")};
},{"./OmsOplog":34,"./OmsOplogSubscriptions":35,"./OmsSubscriptions":36,"./OmsUtils":37}],39:[function(require,module,exports){
...
//# sourceMappingURL=omsweb.js.map